...
#define STARTCOLOR 0xff0000  // LED colors at start
#define BLACK      0x000000  // LED color BLACK

#define DATAPIN    2        // Datapin
#define LEDCOUNT   105       //  Number of LEDs used for boblight
...
//hyperion code
char ledCountPrefix = (LEDCOUNT - 1) & 0xFF; // LED count high byte
char checkSumPrefix = ledCountPrefix ^ 0x55;
//_ledBuffer[4] = (ledValues.size() - 1) & 0xFF;        // LED count low byte
//_ledBuffer[5] = _ledBuffer[3] ^ _ledBuffer[4] ^ 0x55; // Checksum
const char prefix[] = {0x41, 0x64, 0x61, 0x00, ledCountPrefix, checkSumPrefix};  // Start prefix ADA
...
void setup()
{
  ...
  Serial.begin(BAUDRATE);   // Init serial speed
   //Serial.begin(9600);
   //Serial.println(ledCountPrefix,HEX);
   //Serial.println(checkSumPrefix,HEX);
  //delay(10000);
